<div>
    <div
    class="mx-auto overflow-hidden mt-5 shadow-lg mb-2 bg-gray-900 border-4 rounded-lg md:w-2/6 sm:w-4/6 border-gray-400">
    <div class="">
        ...
        @error('math')
            <div class="text-red-500 text-2xl m-2 bg-red-100 rounded-md text-center border border-4 border-red-500">{{ $message }}</div>
        @enderror
